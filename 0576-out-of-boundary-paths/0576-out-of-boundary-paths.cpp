...
int dfs(int i, int j, int n, int m, int moves)
{
    ...
    long long int up = dfs(i-1 , j , n , m , moves-1);
    long long int down = dfs(i+1 , j , n , m , moves-1);
    long long int left = dfs(i , j-1 , n , m , moves-1);
    long long int right = dfs(i , j+1 , n , m , moves-1);
